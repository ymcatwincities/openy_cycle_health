...
/**
 * Settings Form for bingo game.
 */
class SevenSummitsSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'twelve_app_seven_summits_admin_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('twelve_app.seven_summits_settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config = $this->configFactory->getEditable('twelve_app.seven_summits_settings');
